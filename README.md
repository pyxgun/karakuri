...
![Version](https://img.shields.io/badge/release-v0.2.4-blue.svg)
...
Change the host's NIC:`HOST_NIC`, Address: `HOST_ADDR`, OS:`HOST_OS` and architecture:`HOST_ARCH` as necessary.
